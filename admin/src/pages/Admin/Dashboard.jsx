        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Manage your healthcare platform and oversee all operations efficiently
            </p>
          </div>
            ...
            <div className="bg-primary px-6 py-4 flex items-center justify-between">
              ...
              <div className="bg-white/20 px-3 py-1 rounded-full">
                <span className="text-white text-sm font-medium">
                  {dashData.latestAppointment.length} Total
                </span>
              </div>
            </div>
            ...
            <div className="divide-y divide-gray-100">
              {dashData.latestAppointment.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">Recent appointments will appear here when patients book with doctors.</p>
                </div>
              )}
            </div>
          </div>
